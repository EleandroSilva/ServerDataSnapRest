...
type
  TConexaoFiredac = class(TInterfacedObject, iConexao)
    ...
    public
      ...
      function AsJsonArray(Value: TJsonArray)       : iConexao;    overload;
      function AsJsonArray                          : TJsonArray;  overload;
      function FromJSONObject(Value : TJSONObject)  : iConexao; overload;
      function FromJSONObject                       : TJSONObject; overload;
  end;
...
function TConexaoFiredac.FromJSONObject(Value : TJSONObject): iConexao;
begin
  Result := Self;
  FFromJSONObject := FQuery.AsJSONObject;
//  FFromJSONObject := Value;
end;

function TConexaoFiredac.FromJSONObject: TJSONObject;
begin
  Result := FFromJSONObject;
end;

function TConexaoFiredac.AsJsonArray(Value: TJsonArray): iConexao;
begin
  Result := Self;
  FAsJsonArray := Value;
end;
